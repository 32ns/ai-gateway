...
func (r *SQLiteRepository) ListAccounts() []core.Account {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *SQLiteRepository) GetAccount(id string) (core.Account, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *SQLiteRepository) UpsertAccount(account core.Account) error {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *SQLiteRepository) UpsertRuntimeAccount(account core.Account) error {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *SQLiteRepository) DeleteAccount(id string) error {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *SQLiteRepository) UpdateAccountStatus(id string, status core.AccountStatus) error {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *SQLiteRepository) ListAccountGroups() []core.AccountGroup {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *SQLiteRepository) UpsertAccountGroup(group core.AccountGroup) error {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *SQLiteRepository) DeleteAccountGroup(id string) error {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *SQLiteRepository) ListModels() []core.ModelConfig {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *SQLiteRepository) GetModel(id string) (core.ModelConfig, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *SQLiteRepository) UpsertModel(model core.ModelConfig) error {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *SQLiteRepository) ListClients() []core.APIClient {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *SQLiteRepository) ListClientSummaries() []core.APIClient {
	r.mu.RLock()
	defer r.mu.RUnlock()
	...
	for rows.Next() {
		...
		client, err := clientSummaryFromPayload(id, name, ownerUserID, enabled != 0, payload)
		if err != nil {
			continue
		}
		out = append(out, client)
...
func (r *SQLiteRepository) ListClientSummariesPage(offset, limit int) ([]core.APIClient, int) {
	if offset < 0 {
		offset = 0
	}
	if limit <= 0 {
...
func (r *SQLiteRepository) ListClientSummariesByOwnerPage(ownerUserID string, offset, limit int) ([]core.APIClient, int) {
	...
	for rows.Next() {
		...
		client, err := clientSummaryFromPayload(id, name, ownerID, enabled != 0, payload)
		if err != nil {
			continue
		}
		out = append(out, client)
...
func (r *SQLiteRepository) GetClient(id string) (core.APIClient, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *SQLiteRepository) FindClientByAPIKey(apiKey string) (core.APIClient, error) {
...
func (r *SQLiteRepository) UpsertClient(client core.APIClient) error {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *SQLiteRepository) DeleteClient(id string) error {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *SQLiteRepository) UpsertOpenAIResponseBinding(binding core.OpenAIResponseBinding) error {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *SQLiteRepository) GetOpenAIResponseBinding(responseID string) (core.OpenAIResponseBinding, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()

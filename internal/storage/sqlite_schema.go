...
func (r *SQLiteRepository) initSchemaLocked() error {
	// Domain objects are stored as JSON payloads. Columns next to the payload are
	// for constraints or hot lookup paths and must be kept in sync on write.
	statements := []string{
		...
		`CREATE TABLE IF NOT EXISTS user_balances (
			...
			balance_nano_usd INTEGER NOT NULL DEFAULT 0,
			updated_at_ns INTEGER NOT NULL DEFAULT 0,
		...
		`CREATE TABLE IF NOT EXISTS user_oauth_identities (
			...
			username TEXT NOT NULL DEFAULT '',
			linked_at_ns INTEGER NOT NULL DEFAULT 0,
		...
		`CREATE TABLE IF NOT EXISTS client_spend (
			...
			spend_limit_nano_usd INTEGER NOT NULL DEFAULT 0,
			spend_used_nano_usd INTEGER NOT NULL DEFAULT 0,
			updated_at_ns INTEGER NOT NULL DEFAULT 0,
		...
		`CREATE TABLE IF NOT EXISTS finance_user_rollups (
			...
			username TEXT NOT NULL DEFAULT '',
			balance_nano_usd INTEGER NOT NULL DEFAULT 0,
			recharge_nano_usd INTEGER NOT NULL DEFAULT 0,
			reward_nano_usd INTEGER NOT NULL DEFAULT 0,
			spend_nano_usd INTEGER NOT NULL DEFAULT 0,
			usage_spend_nano_usd INTEGER NOT NULL DEFAULT 0,
			plan_spend_nano_usd INTEGER NOT NULL DEFAULT 0,
			refund_nano_usd INTEGER NOT NULL DEFAULT 0,
			last_payment_at_ns INTEGER NOT NULL DEFAULT 0,
			last_spend_at_ns INTEGER NOT NULL DEFAULT 0
		)`,
		...
		`CREATE TABLE IF NOT EXISTS finance_client_rollups (
			...
			spend_limit_nano_usd INTEGER NOT NULL DEFAULT 0,
			spend_used_nano_usd INTEGER NOT NULL DEFAULT 0,
			usage_nano_usd INTEGER NOT NULL DEFAULT 0,
			plan_nano_usd INTEGER NOT NULL DEFAULT 0
		)`,
		...
		`CREATE TABLE IF NOT EXISTS billing_requests (
			...
			account_group_multiplier_bps INTEGER NOT NULL DEFAULT 0,
			...
			image_output_tokens INTEGER NOT NULL DEFAULT 0,
			total_tokens INTEGER NOT NULL DEFAULT 0,
			input_price_nano_usd_per_1m INTEGER NOT NULL DEFAULT 0,
			cached_input_price_nano_usd_per_1m INTEGER NOT NULL DEFAULT 0,
			cache_write_price_nano_usd_per_1m INTEGER NOT NULL DEFAULT 0,
			cache_write_5m_price_nano_usd_per_1m INTEGER NOT NULL DEFAULT 0,
			cache_write_1h_price_nano_usd_per_1m INTEGER NOT NULL DEFAULT 0,
			output_price_nano_usd_per_1m INTEGER NOT NULL DEFAULT 0,
			image_output_price_nano_usd_per_1m INTEGER NOT NULL DEFAULT 0,
			...
			created_at_ns INTEGER NOT NULL,
			settled_at_ns INTEGER NOT NULL DEFAULT 0,
		...
		`CREATE TABLE IF NOT EXISTS billing_ledger (
			...
			balance_after_nano_usd INTEGER NOT NULL,
		...
		`CREATE TABLE IF NOT EXISTS billing_plans (
			...
			enabled INTEGER NOT NULL DEFAULT 1,
			price_nano_usd INTEGER NOT NULL DEFAULT 0,
			period_quota_nano_usd INTEGER NOT NULL DEFAULT 0,
			period_duration_sec INTEGER NOT NULL DEFAULT 86400,
		...
		`CREATE TABLE IF NOT EXISTS user_plan_entitlements (
			...
			price_nano_usd INTEGER NOT NULL DEFAULT 0,
			period_quota_nano_usd INTEGER NOT NULL DEFAULT 0,
			base_period_quota_nano_usd INTEGER NOT NULL DEFAULT 0,
			period_duration_sec INTEGER NOT NULL DEFAULT 86400,
			total_periods INTEGER NOT NULL DEFAULT 1,
			remaining_periods INTEGER NOT NULL DEFAULT 1,
			current_quota_nano_usd INTEGER NOT NULL DEFAULT 0,
			priority INTEGER NOT NULL DEFAULT 0,
			current_period_started_at_ns INTEGER NOT NULL DEFAULT 0,
			current_period_ends_at_ns INTEGER NOT NULL DEFAULT 0,
			expires_at_ns INTEGER NOT NULL DEFAULT 0,
			purchased_at_ns INTEGER NOT NULL DEFAULT 0,
			updated_at_ns INTEGER NOT NULL DEFAULT 0
		)`,
		...
		`CREATE TABLE IF NOT EXISTS plan_quota_ledger (
			...
			kind TEXT NOT NULL,
			amount_nano_usd INTEGER NOT NULL,
			quota_after_nano_usd INTEGER NOT NULL,
			note TEXT NOT NULL DEFAULT '',
			created_at_ns INTEGER NOT NULL
		)`,
		...
		`CREATE TABLE IF NOT EXISTS payment_orders (
			...
			paid_at_ns INTEGER NOT NULL DEFAULT 0,
			payload TEXT NOT NULL,
			created_at_ns INTEGER NOT NULL,
			updated_at_ns INTEGER NOT NULL
		)`,
		...
		`CREATE TABLE IF NOT EXISTS site_message_reads (
			...
			FOREIGN KEY(message_id) REFERENCES site_messages(id) ON DELETE CASCADE,
			FOREIGN KEY(user_id) REFERENCES users(id) ON DELETE CASCADE
		)`,
		...
		`CREATE TABLE IF NOT EXISTS support_tickets (
			...
			last_read_by_user_at_ns INTEGER NOT NULL DEFAULT 0,
			last_read_by_admin_at_ns INTEGER NOT NULL DEFAULT 0,
			created_at_ns INTEGER NOT NULL,
			updated_at_ns INTEGER NOT NULL,
		...
		`CREATE TABLE IF NOT EXISTS monitor_results (
			...
			checked_at_ns INTEGER NOT NULL DEFAULT 0,
			payload TEXT NOT NULL
		)`,
		...
		`CREATE TABLE IF NOT EXISTS audit_terms (
			...
			FOREIGN KEY(seq) REFERENCES audit(seq) ON DELETE CASCADE
		)`,
	...
	for _, statement := range []string{
		...
		`ALTER TABLE billing_requests ADD COLUMN cache_creation_tokens INTEGER NOT NULL DEFAULT 0`,
		`ALTER TABLE billing_requests ADD COLUMN cache_creation_5m_tokens INTEGER NOT NULL DEFAULT 0`,
		`ALTER TABLE billing_requests ADD COLUMN cache_creation_1h_tokens INTEGER NOT NULL DEFAULT 0`,
		`ALTER TABLE billing_requests ADD COLUMN image_output_tokens INTEGER NOT NULL DEFAULT 0`,
		`ALTER TABLE billing_requests ADD COLUMN cache_write_price_nano_usd_per_1m INTEGER NOT NULL DEFAULT 0`,
		`ALTER TABLE billing_requests ADD COLUMN cache_write_5m_price_nano_usd_per_1m INTEGER NOT NULL DEFAULT 0`,
		`ALTER TABLE billing_requests ADD COLUMN cache_write_1h_price_nano_usd_per_1m INTEGER NOT NULL DEFAULT 0`,
		`ALTER TABLE billing_requests ADD COLUMN image_output_price_nano_usd_per_1m INTEGER NOT NULL DEFAULT 0`,
		`ALTER TABLE billing_requests ADD COLUMN cache_diagnostics TEXT NOT NULL DEFAULT ''`,
		`ALTER TABLE openai_response_bindings ADD COLUMN prompt_cache_key TEXT NOT NULL DEFAULT ''`,
		`ALTER TABLE finance_token_daily_rollups ADD COLUMN cache_creation_tokens INTEGER NOT NULL DEFAULT 0`,
		`ALTER TABLE finance_token_daily_rollups ADD COLUMN image_output_tokens INTEGER NOT NULL DEFAULT 0`,
	} {
		if _, err := r.db.Exec(statement); err != nil && !sqliteDuplicateColumnError(err) {
			return err
		}
	}

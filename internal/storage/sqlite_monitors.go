...
func (r *SQLiteRepository) ListMonitorTargets() []core.MonitorTarget {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *SQLiteRepository) GetMonitorTarget(id string) (core.MonitorTarget, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *SQLiteRepository) UpsertMonitorTarget(target core.MonitorTarget) error {
	r.mu.Lock()
	defer r.mu.Unlock()
	...
	_, err = r.db.Exec(
		...
		boolToInt(target.PublicVisible),
...
func (r *SQLiteRepository) DeleteMonitorTarget(id string) error {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *SQLiteRepository) AppendMonitorResult(result core.MonitorResult) error {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *SQLiteRepository) ListMonitorResults(targetID string, limit int) []core.MonitorResult {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *SQLiteRepository) ListLatestMonitorResults() map[string]core.MonitorResult {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *SQLiteRepository) trimMonitorResultsLocked(targetID string) error {
	targetID = strings.TrimSpace(targetID)

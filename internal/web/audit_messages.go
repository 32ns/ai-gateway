...
func auditSystemSettingsChangeMessage(before, after core.SystemSettings, hasBefore bool) string {
	...
	return auditChangeMessage(
		...
		auditBoolChange("linuxdo_login_enabled", before.OAuth.LinuxDOLoginEnabled, after.OAuth.LinuxDOLoginEnabled),
		auditTextChange("linuxdo_login_client_id", before.OAuth.LinuxDOClientID, after.OAuth.LinuxDOClientID),
		auditBoolChange("linuxdo_login_secret_changed", false, before.OAuth.LinuxDOSecret != after.OAuth.LinuxDOSecret),
